# I dont't know who will see this program
# But I'm sure that you must have made the worst choice
...
# Urban Distance and Information Elements
...
class Ant(object):
    ...
    def __init__(self,ID):
        ...
        self.ID = ID                 # ID
        self.__clean_data()          # Random generation
